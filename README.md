...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyterlab_commands-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyterlab_commands-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyterlab_commands
# for installing globally
pixi global install jupyterlab_commands
```
...
It is possible to list all of the versions of `jupyterlab_commands` available on your platform:
...
```
pixi search jupyterlab_commands --channel conda-forge
```
