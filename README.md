...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab_commands-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9632&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab_commands-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab_commands` can be installed with:

```
conda install jupyterlab_commands
```

It is possible to list all of the versions of `jupyterlab_commands` available on your platform with:
